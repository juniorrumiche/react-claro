...
import {  Planes1PlayDB, Planes2PlaySuperior } from "../db/db";
...
export const Play2SuperPage = () => {
  return (
    <>
      <Helmet>
        <title>Planes 2Play Superior | Internet Hogar</title>
      </Helmet>
      <Navbar />
      ...
      <Container maxWidth="6xl" py={10}>
        ...
        <LazyLoadComponent>
          <SimpleGrid py={10} columns={{ base: 1, md: 3 }} gap={8}>
            {Planes2PlaySuperior.map((plan, index) => (
